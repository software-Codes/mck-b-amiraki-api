...
const emailTemplates = {
  adminAlert: ({ suggestion, dashboardLink }) => ({
    subject: `🚨 New ${suggestion.urgency_level} priority suggestion received from MCK Bishop Amiraki Church Member !`,
    html: html`
      <div
        style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #ffffff;"
      >
        <!-- Header with Logo and Church Name -->
        <div
          style="background-color: #3498db; padding: 20px; text-align: center;"
        >
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8UQP4q2fVpayP0gCBGrYfPNFxOK4vJ8K81FBJNrA-WqR3SiZB6Y0Cv1F0X1x51vd3ISHO_w&s"
            alt="MCK Bishop Amiraki Church Logo"
            style="max-height: 60px; display: block; margin: 0 auto 10px;"
          />
          <h1 style="color: #ffffff; margin: 0; font-size: 28px;">
            MCK Bishop Amiraki Church
          </h1>
          <h2 style="color: #ffffff; margin: 5px 0 0; font-size: 20px;">
            New Suggestion Alert
          </h2>
        </div>
        ...
        <div style="padding: 20px;">
          ...
          <div
            style="background-color: #f0f8ff; padding: 15px; border: 1px solid #3498db; border-radius: 8px;"
          >
            ${suggestion.title
            ...
            <p style="margin: 5px 0;">
              ...
              <span
                style="color: ${suggestion.urgency_level === "critical"
                  ? "#e74c3c"
                  : suggestion.urgency_level === "high"
                  ? "#e67e22"
                  : "#2ecc71"}; font-weight: bold;"
              >
                ${suggestion.urgency_level.toUpperCase()}
              </span>
            </p>
            <p style="margin: 5px 0;">
              <strong>Submitted by:</strong> ${suggestion.user_name}
            </p>
            <p style="margin: 5px 0;">
          ...
          <!-- Footer -->
          <div
            style="paddin  g: 20px; text-align: center; background-color: #f8f9fa;"
          >
            <p style="color: #7f8c8d; font-size: 12px; margin: 0;">
              This is an automated notification from MCK Bishop Amiraki Church.
    ...
    html: html`
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <h3 style="color: #27ae60;">
          Thank you, ${userName}! for your suggestion to MCK Bishop Amiraki
          church
        </h3>
        <p>
          We've received your suggestion and our team will review it shortly.
        </p>
